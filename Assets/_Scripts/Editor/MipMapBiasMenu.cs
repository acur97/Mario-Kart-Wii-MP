...
class MipMapBiasMenu
{
    ...
    //  Maxima Alta calidad
    [MenuItem("Assets/Seleccionar Mipmap Bias/Maxima Alta Calidad (-1.25)", true)]
    ...
    //  Altisima calidad
    [MenuItem("Assets/Seleccionar Mipmap Bias/Altisima Calidad (-0.75)", true)]
